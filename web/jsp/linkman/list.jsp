                        ...
                        <TD height=25>
                            <TABLE cellSpacing=0 cellPadding=2 border=0>
                                ...
                                <TR>
                                    <TD>联系人名称：</TD>
                                    <TD>
                                    <s:textfield theme="simple" name="lkm_name" cssClass="textbox" id="sChannel2"
                                                 cssStyle="WIDTH: 80px" maxLength="50"/>
                                    </TD>&nbsp;

                                    <TD>联系人性别：</TD>
                                    <TD>
                                        <s:select theme="simple" name="lkm_gender" list="#{'1':'男','2':'女'}" headerKey=""
                                                  headerValue="-请选择-" />
                                    </TD>&nbsp;
    ...
    <option value="5"
        ...
        <option value="10"
            ...
            <s:if test="currPage != 1">
                ...
                [<A href="javascript:to_page(<s:property value="currPage - 1"/>)">前一页
                </A>]
            </s:if>
            <B>
            ...
            <s:if test="currPage < totalPage">
                [<A href="javascript:to_page(<s:property value="currPage + 1"/>)">后一页
                </A>]
